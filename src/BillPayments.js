...
export default class BillPayments extends Component {
  ...
  updateAccountNum = (accNum) =>
  {
    this.setState({accNum: accNum})
  }
  ...
  InitiateTransfers = () =>
  {
    ...
    var DebitCreditAPI = 'https://uncoiled-crust.000webhostapp.com/api/debitCreditAc.php?accountToDebit='+DebitAccount+'&accountToCredit=0023457321&amount='+amount+'';
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        onChangeText={billername => this.setState({billername})}
        style={styles.input}
        />
        ...
        <View style={styles.space2} />
        <TextInput
        placeholder = " Biller Category (Eg Electricity)"
        onChangeText={billercat => this.setState({billercat})}
        style={styles.input}
        />
        <View style={styles.space2} />
        <TextInput
